          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link href="/topics/smartphones" className="hover:text-white transition-colors">Smartphones</Link></li>
                <li><Link href="/topics/laptops" className="hover:text-white transition-colors">Laptops & PCs</Link></li>
                <li><Link href="/topics/audio" className="hover:text-white transition-colors">Audio & Headphones</Link></li>
              </ul>
            </div>
            <div>
